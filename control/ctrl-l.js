...
const device = iot.device({
    productKey: "a18UcnTHSUr", //将<productKey>修改为实际产品的ProductKey
    deviceName: "deng",//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: "555b63b01cbf226efab7b5814bff261a",//将<deviceSecret>修改为实际设备的DeviceSecret
});

//监听connect事件
device.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device.subscribe('/a18UcnTHSUr/deng/user/get');
    device.publish('/a18UcnTHSUr/deng/user/update', 'hello world!');
});
