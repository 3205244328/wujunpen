...
const device5 = iot.device({
    productKey: "a1XJ0m6Iwl8", //将<productKey>修改为实际产品的ProductKey
    deviceName: "kongtiao",//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: "d958dc45c7a09a05d349605055a1ddff",//将<deviceSecret>修改为实际设备的DeviceSecret
});

//监听connect事件
device5.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device5.subscribe('/a1XJ0m6Iwl8/kongtiao/user/get');
    device5.publish('/a1XJ0m6Iwl8/kongtiao/user/update', 'hello world!');
});
