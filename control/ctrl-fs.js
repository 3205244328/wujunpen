...
const device4 = iot.device({
    productKey: "a1j9uDtcfTJ", //将<productKey>修改为实际产品的ProductKey
    deviceName: "fengshan",//将<deviceName>修改为实际设备的DeviceName
    deviceSecret: "df3dc28de597031555530b65336319ef",//将<deviceSecret>修改为实际设备的DeviceSecret
});

//监听connect事件
device4.on('connect', () => {
    //将<productKey> <deviceName>修改为实际值
    device4.subscribe('/a1j9uDtcfTJ/fengshan/user/get');
    device4.publish('/a1j9uDtcfTJ/fengshan/user/update', 'hello world!');
});
